...
public class AppCluster {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 第一步：与canal进行连接
        CanalConnector connector = CanalConnectors.newClusterConnector("101.201.224.95:2183", "example", "", "");
        ...
        try {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    System.out.println(String.format("当前已用时：%s秒",String.valueOf((endTime-startTime)/1000)));
                }
            }
    ...
    public static void PrintEntry(List<Entry> entrys) {
        ...
        for (Entry entry : entrys) {
            ...
            System.out.println(String.format("binlog名称：%s ，消费位点：%s", logFileName,String.valueOf(logFileOffset)));
    ...
    public static void PrintColumn(List<Column> columns) {
        ...
        JSONObject.toJSONBytes(columns,SerializerFeature.WriteEnumUsingName,SerializerFeature.IgnoreNonFieldGetter,SerializerFeature.IgnoreErrorGetter);
